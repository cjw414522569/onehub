...
if (process.argv.includes('--write')) {
  ...
  const report = {
    ...
    coverage: {
      ...
      feature_matrix:
        'docs/reports/FEATURES_MATRIX.json: 196 copied UI commands classified (wired=192 real backend T001-T050, interface_only=4 explicit boundary, pending=0); nothing faked',
      contract:
