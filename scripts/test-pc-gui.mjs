...
if (process.argv.includes('--write')) {
  ...
  const report = {
    ...
    coverage: {
      ...
      feature_matrix:
        'docs/reports/FEATURES_MATRIX.json: 150 copied UI commands classified (wired=146 real backend T001-T018/T019 MySQL, interface_only=4 explicit boundary, pending=0); nothing faked',
      contract:
