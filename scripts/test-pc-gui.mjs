...
if (process.argv.includes('--write')) {
  ...
  const report = {
    ...
    coverage: {
      ...
      feature_matrix:
        'docs/reports/FEATURES_MATRIX.json: 148 copied UI commands classified (wired=144 real backend T001-T018/T018 db framework, interface_only=4 explicit boundary, pending=0); nothing faked',
      contract:
