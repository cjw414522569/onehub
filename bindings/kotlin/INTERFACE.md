# Kotlin binding interface

This directory reserves the L4 binding boundary for Android clients.
...
- Native compilation is intentionally deferred until a Kotlin/Gradle toolchain is available.
